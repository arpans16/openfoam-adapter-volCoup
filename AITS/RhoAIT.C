...
void preciceAdapter::AITS::Rho::write(double * buffer, bool meshConnectivity, const unsigned int dim)
{
    int bufferIndex = 0;
...
void preciceAdapter::AITS::Rho::read(double * buffer, const unsigned int dim)
{
    int bufferIndex = 0;
