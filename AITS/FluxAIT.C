...
void preciceAdapter::AITS::Flux::write(double * buffer, bool meshConnectivity, const unsigned int dim)
{
    int bufferIndex = 0;
...
void preciceAdapter::AITS::Flux::read(double * buffer, const unsigned int dim)
{
    int bufferIndex = 0;
